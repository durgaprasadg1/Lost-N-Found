...
export async function PATCH(req, { params }) {
  try {
    ...
    <div style="max-width:600px;margin:0 auto;font-family:Arial,Helvetica,sans-serif;color:#333;">
          ...
          <p>
            We are writing to inform you that recent activities linked to your account
          ...
          <p style="margin-top:12px;">
            These guidelines exist to ensure the platform remains helpful,
            reliable, and fair for all users.
          </p>

          <p style="margin-top:12px;">
            Please review and correct your future submissions carefully.
            Continued misuse may lead to temporary restrictions or suspension of your account.
          </p>

          <p style="margin-top:16px;">
            If you believe this notice was sent in error or need clarification,
    ...
    <div style="max-width:600px;margin:0 auto;font-family:Arial,Helvetica,sans-serif;color:#333;">
      ...
      <p>
        After review, your account has been
      ...
      <p style="margin-top:12px;">
        As a result, your account access has been disabled, and you
        will no longer be able to create or manage lost or found requests.
      </p>

      <p style="margin-top:12px;">
        This decision aims to maintain a trustworthy and effective environment for all users.
      </p>

      <p style="margin-top:14px;">
        If you believe this action was taken in error, you may contact our support team
        with relevant details for review. Account reinstatement is not guaranteed.
      </p>
  ...
  `,
    ...
    <div style="max-width:600px;margin:0 auto;font-family:Arial,Helvetica,sans-serif;color:#333;">
      ...
      <p>
        Your account on the <strong>Lost & Found</strong> platform has been
        <strong>unblocked</strong> following administrative review.
      </p>

      <p style="margin-top:12px;">
        You may now access your account and continue using the platform as intended.
      </p>

      <p style="margin-top:12px;">
        Please ensure future submissions comply with our guidelines, including providing
        accurate details and relevant images for lost or found requests.
      </p>

      <p style="margin-top:12px;">
        Following these guidelines helps maintain a reliable and helpful environment for all users.
      </p>
...
export async function DELETE(req, { params }) {
  try {
    ...
    <div style="max-width:600px;margin:0 auto;font-family:Arial,Helvetica,sans-serif;color:#333;">
      ...
      <p>
        This email formally notifies you that your account on the
        <strong>Lost & Found</strong> platform has been
        <strong>permanently deleted</strong>.
      </p>

      <p style="margin-top:12px;">
        This action followed multiple reviews and prior warnings about repeated
        violations of our platform usage guidelines, including but not limited to:
      </p>
      ...
      <p style="margin-top:14px;">
        ...
        team for clarification. Reinstatement is not guaranteed.
      </p>
